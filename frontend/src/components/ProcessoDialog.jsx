  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Publicação - {processo.numero_processo}</DialogTitle>
        </DialogHeader>

        <div className="grid gap-2 mt-4 text-sm">
          <p><strong>Data de Disponibilização:</strong></p>
          <p>{new Date(processo.data_disponibilizacao).toLocaleDateString("pt-BR")}</p>
          ...
          <p><strong>Valor principal bruto/líquido:</strong></p>
          <p>{processo.valor_principal_bruto_liquido || "-"}</p>

          <p><strong>Valor dos juros moratórios:</strong></p>
          <p>{processo.juros_moratorios || "-"}</p>

          <p><strong>Juros dos honorários advocatícios:</strong></p>
          <p>{processo.honorarios_adv || "-"}</p>

          <div>
            <p><strong>Conteúdo da Publicação:</strong></p>
            <p className="whitespace-pre-wrap">{displayContent}{!showFullContent && isLong && "..."}</p>
